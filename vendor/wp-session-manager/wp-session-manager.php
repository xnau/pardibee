...
add_action('admin_init',      array('EAMann\WPSession\DatabaseHandler', 'create_table'));
add_action('wp_session_init', array('EAMann\WPSession\DatabaseHandler', 'create_table'));
add_action('wp_install',      array('EAMann\WPSession\DatabaseHandler', 'create_table'));
