...
c);f.val(c)},m=function(){!1===b?b=!0:(b=!1,h(!1));d.find(".delete-check").each(function(){a(this).prop("checked",b);k(b)})},n=a("<div/>").dialog({dialogClass:"confirmation-dialog participants-database-confirm",modal:!0,zIndex:1E4,autoOpen:!1,width:"auto",resizable:!1,buttons:[{icon:"dashicons dashicons-yes",click:function(){d.prepend(l.clone().val(list_adminL10n.apply));h(!0);b=!1;a(this).dialog("destroy");d.submit()}},{icon:"dashicons dashicons-no-alt",click:function(){b=!0;a(this).dialog("close").html("")}}]});
return{init:function(){e.on("click",function(b){b.preventDefault();var c=parseInt(f.val(),10);b=1<c?"plural":"singular";var d=a("[name=with_selected]").val();c=!list_adminL10n.unlimited_actions.includes(d)&&c>parseInt(list_adminL10n.send_limit)?a('<h4 class="dashicons-before dashicons-warning"/>').append(list_adminL10n.apply_confirm.recipient_count_exceeds_limit.replace("{limit}",list_adminL10n.send_limit)):"";n.append(a("<h3/>").append(list_adminL10n.apply_confirm[d][b])).append(c).dialog("open").find("a").blur()});
