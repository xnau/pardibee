...
!1),b--);0>b&&(b=0);l(0<b);h.val(b)},u=function(){!1===e?e=!0:(e=!1,l(!1));f.find(".delete-check").each(function(){a(this).prop("checked",e);p(e)})},r=function(c){c=c.target?a(c.target):a(c);var b=c.closest(".list-controls").find(".mass-edit-control"),d=c.closest(".list-controls").find(".file-delete-preference-selector");b.hide(300);d.hide(300);switch(c.val()){case mass_editL10n.edit_action:b.show(300);q(c);break;case "delete":d.show(300)}},q=function(c){var b=(c.target?a(c.target):a(c)).closest(".list-controls"),
d=b.find(".mass-edit-input");d.find(".field-input-label, .field-input").fadeTo(300,0,function(){d.addClass("changeout")});d.append(n);c={action:mass_editL10n.action};b=b.find('[name="'+mass_editL10n.selector+'"]').val();c[mass_editL10n.selector]=b;c[b]=a(".mass-edit-input [name="+b+"]").val();a.post(ajaxurl,c,function(a){d.html(a.input);d.find(".field-input-label, .field-input").fadeTo(300,1);d.removeClass("changeout");PDbOtherSelect.init();PDbDatepicker&&PDbDatepicker.init()})},v=a("<div/>").dialog({dialogClass:"confirmation-dialog participants-database-confirm",
