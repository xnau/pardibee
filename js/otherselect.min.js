...
c.on("change",'input[type="radio"]',q);c.on("click","input.otherfield",r);c.find(".otherselect").trigger("change");d(":focus").blur()}}}(jQuery);jQuery(function(){PDbOtherSelect.init()});