...
<div class="text-block">
  ...
  <p><?php printf( __( 'Please visit the %sManage Database Fields Help Page%s for detailed help with configuring the database fields.', 'participants-database' ), '<a href="https://xnau.com/the-manage-database-fields-page/" target="_blank">', '</a>' ) ?></p>
